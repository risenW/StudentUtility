...
public class Calculator {
    ...
    final Function sinh = new Function("sinh", 1);
    final Function cosh = new Function("cosh", 1);
    final Function tanh = new Function("tanh", 1);
        ...
        evaluator = new DoubleEvaluator(params) {
            ...
            protected Double evaluate(Function function, Iterator arguments, Object evaluationContext) {
                if (function == sqrt)
                    ...
                    return Math.toDegrees(Math.asin((Double)arguments.next()));
                }
                else if(function == atan){
                    return Math.toDegrees(Math.atan((Double)arguments.next()));
                }
                else if(function == acos){
                    return Math.toDegrees(Math.acos((Double)arguments.next()));
                }
                else if(function == sinh){
                    return Math.sinh((Double)arguments.next());
                }
                else if(function == cosh){
                    return Math.cosh((Double)arguments.next());
                }
                else if(function == tanh){
                    return Math.tanh((Double)arguments.next());
                }
